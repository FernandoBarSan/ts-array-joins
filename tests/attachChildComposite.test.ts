...
describe("attachChildComposite", () => {
  ...
  it("should attach first matching child using composite key", () => {
  ...
  it("should use first-match-wins with composite keys", () => {
